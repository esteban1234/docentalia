...
<html lang="es">
  <head>
    ...
    <title>CORPORATIVO DOCENTALIA</title>
   <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <META NAME="Title" content="CORPORATIVO DOCENTALIA">
    <META NAME="Author" CONTENT="[http://docentalia.com/]"/>
    <META name="Description" content="Venta de gasolina y diésel, Refinación de petróleo, Producción, elaboración de combustibles automotrices. Fabricación o producción de combustibles fósiles. Fabricación de motores de combustión interna, turbinas y transmisiones, Fabricación de otras partes para vehículos automotrices."/>
   <META NAME="Keywords" CONTENT="Venta de gasolina y diésel, Refinación de petróleo, Producción, elaboración de combustibles automotrices. Fabricación o producción de combustibles fósiles. Fabricación de motores de combustión interna, turbinas y transmisiones, Fabricación de otras partes para vehículos automotrices."/>
...
<div class="bannerh" id="INICIO">
  <div class="fondo">
    ...
    <div style="text-align: center; margin-top: 5%; margin-bottom: 5%;">
      <a class="btn btn-primary btn-outline btn-lg btn-color" data-scroll href="#CONTACTO">CONTACTANOS</a>
    </div>
  </div>
</div>
  ...
  <p class="text-center">Ponemos a su disposición nuestra amplia experiencia y asesoramiento en cuanto a la venta de combustible:</p> <br><br><br>
    ...
    <div class="pricing-grids">
      <div class="col-xs-12 col-sm-4 col-md-4 pric-grid effect">
        ...
        <div class="pric-list">
          <ul>
            <li>Combustible especializado para vehículos automotrices Diésel</li>
            </ul>
        </div>
      </div>      
      <div class="col-xs-12 col-sm-4 col-md-4 pric-grid effect">
        ...
        <div class="pric-list">
          <ul>
            <li>Combustible especialmente indicado para obtener el máximo rendimiento en maquinaria de uso industrial, agrícola y calderas.</li>
          </ul>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4 pric-grid effect">
        ...
        <div class="pric-list">
          <ul>
            <li>Se utiliza Como combustible doméstico e industrial, Como carburante y lubricante, Como materia prima básica en la industria petroquímica, etc.</li>
          </ul>
        </div>
        </div>
...
<section class="seccion3" id="CONTACTO">
  ...
  <div class="row">
    <div class="col-sm-12" id="parent">
      <div class="col-sm-6">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d232.78788626644382!2d-89.62302374620555!3d21.008417859565466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f5676a86061e939%3A0x700a62b9e77240f2!2sCalle11+335%2C+Fraccionamiento+del+Nte%2C+97120+M%C3%A9rida%2C+Yuc.!5e0!3m2!1ses-419!2smx!4v1507763194130" width="100%" height="320px" frameborder="0" style="border:0" allowfullscreen></iframe>
      </div>
      ...
      <div class="box">             
        <div class="icon">
          ...
          <div class="info">
            ...
            <p>
              <i class="fa fa-envelope" aria-hidden="true"></i> &nbsp info@docentalia.com
              <br>
              <br>
              <i class="fa fa-globe" aria-hidden="true"></i> &nbsp www.docentalia.com
            </p>
        ...
        <div class="icon">
          ...
          <div class="info">
            <h3 class="title">DIRECCION</h3>
              <p>
               <i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp C.11 #335-A POR 60 Y 38 COL. FRACC. DEL NORTE, MERIDA, YUC. C.P.97120
            </p>
          </div>
        </div>
        <div class="space"></div>
...
<footer>
<p>Derechos de autor 2017 © | CORPORATIVO DOCENTALIA S.A. DE C.V.</p>
</footer>
